...
import { faQuestionCircle, faMoneyBill } from '@fortawesome/free-solid-svg-icons'
...
class Game extends Component {
  ...
  handleHit = () => {
    ...
    // dispatch account balance update
  }
    ...
    <Modal animationType="slide" visible={this.state.modalVisible}>
      ...
      >
        ...
        >
          ...
          <Text>
            There are 6 decks in total. Dealer must draw to all totals of 16 or less and stand on
            all totals of 17 to 21.{' '}
          </Text>
          <Image
            source={require('Assets/Images/strip.jpeg')}
            style={{ width: 200, height: 200, marginTop: 20, marginBottom: 20, marginLeft: 50 }}
          />
          <Button
  ...
  _renderAccountModal = () => (
    <Modal animationType="slide" visible={this.state.accountVisible}>
      <Profile onClose={() => this.setMoneyModalVisible(!this.state.accountVisible)} />
    </Modal>
  )
      ...
      <ImageBackground style={styles.background} source={require('Assets/Images/background.jpeg')}>
        ...
        >
          <TouchableOpacity
            ...
            onPress={() => this.setMoneyModalVisible(!this.state.accountVisible)}
          >
            <FontAwesomeIcon icon={faMoneyBill} size={24} color={'white'} style={styles.icon} />
            <Text
              style={{
                color: 'white',
                fontSize: 20,
          ...
          <TouchableOpacity style={styles.navBarRightButton}  onPress={this.props.closeGame}>
            <Text
              style={{
                color: 'white',
                fontSize: 20,
        ...
        <View style={styles.container}>
          <View style={{ flex: 2, marginTop: -10 }}>
            <Text style={{ color: 'white', fontSize: 15, fontWeight: '800', textAlign: 'center' }}>
              {' '}
              House Hand{' '}
            </Text>
